 ...
 *
 * <p>
 * <b>IMPORTANT:</b> The raw request body MUST be read as a String before any
 * Jackson deserialization, because Stripe's signature verification requires the
 * exact original byte sequence. Spring's {@code @RequestBody String} achieves
 * this.
 *
 * <p>
 * Endpoint: {@code POST /api/webhooks/stripe}
 * <br>
 * Security: Public (permit-all in SecurityConfig) protected by Stripe
 * signature.
 */
@RestController
...
public class StripeWebhookController {
     ...
     * </ol>
     *
     * @param payload   Raw JSON body (NOT parsed required for signature
     *                  verification)
