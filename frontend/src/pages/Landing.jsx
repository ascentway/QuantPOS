...
const Landing = () => {
  ...
  /* ─────────────────────────────────────────────────────────────────────
     ...
     Dark: Brand deep navy #0B1325 with teal/mint glow
     Light: Clean white with brand navy text and teal accents
  ───────────────────────────────────────────────────────────────────── */
  const T = isDark ? {
    /* Backgrounds */
    ...
    brand: '#00F5D4',          /* Indigo-400: readable & vivid */
    brandHov: '#00C5C5',
    brandBg: 'rgba(0,245,212,0.1)',
    brandBorder: 'rgba(0,245,212,0.20)',
    /* Semantic */
    success: '#34D399',
    ...
    /* Pricing highlight */
    planHighBg: 'linear-gradient(150deg,rgba(0,245,212,.10) 0%,rgba(11,19,37,0.98) 55%)',
    planHighBorder: 'rgba(0,245,212,0.28)',
    /* Hero & CTA gradients */
    heroBg: 'radial-gradient(ellipse 75% 60% at 12% -8%, rgba(0,164,164,.14) 0%, transparent 60%), radial-gradient(ellipse 55% 45% at 88% 95%, rgba(0,245,212,.08) 0%, transparent 60%), #0B1325',
    ctaBg: 'radial-gradient(ellipse 65% 55% at 50% 50%, rgba(0,164,164,.10) 0%, transparent 68%), #0B1325',
    /* Mockup UI */
    mockSidebar: '#020509',
    mockContent: '#0C111D',
    mockCard: '#111827',
    ...
    headlineAccent: '#00F5D4',        /* Brand mint on dark bg */
  } : {
    /* Backgrounds */
    ...
    brand: '#00A4A4',          /* Teal: brand primary */
    brandHov: '#008B8B',
    brandBg: '#E0F7F7',          /* Teal-50 wash */
    brandBorder: '#80D4D4',          /* Mid teal border */
    /* Semantic */
    success: '#059669',
    successBg: '#D1FAE5',
    amber: '#D97706',
    ...
    mockMuted: '#9CA3AF',
    /* Headline accent color (solid  NO gradient clip trick) */
    headlineAccent: '#0C206D',        /* Teal: brand primary on white */
  };
  ...
  const faqs = [
    ...
    { q: 'Is my data safe? Can another store see my records?', a: 'Your data is completely isolated from every other business. We use database-level multi-tenancy with full encryption at rest and in transitbank-grade security.' },
    { q: 'How does the 14-day free trial work?', a: 'Sign up and get full access to the Growth plan for 14 daysno credit card required. After that, choose the plan that fits your business.' },
    ...
    { q: 'Is QuantPOS GST-compliant for India?', a: 'Yes. GST is built inGSTIN validation, tax-correct invoices, and HSN/SAC code support are all included from day one.' },
  ];
      ...
      <div style={{ background: T.page, color: T.t1, transition: 'background .3s ease, color .3s ease' }} className={`relative min-h-screen w-full overflow-x-hidden ${isDark ? 'dark' : ''}`}>
        ...
        >
          <div className="max-w-[1280px] mx-auto px-6 md:px-10 h-[64px] flex items-center justify-between">
            <Link to="/"><Wordmark isDark={isDark} height={30} /></Link>
        ...
        {menuOpen && (
          <div className="fixed inset-0 z-[100] flex flex-col" style={{ background: T.page, backdropFilter: 'blur(24px)' }}>
            <div className="flex items-center justify-between px-6 h-16">
              <Wordmark isDark={isDark} height={28} />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="qp-reveal">
                ...
                <p className="font-inter text-[16px] leading-relaxed mb-8" style={{ color: T.t2 }}>
                  ...
                  QuantPOS gives you morefor a fraction of the cost, with the flexibility your business demands.
                </p>
          ...
          <div className="max-w-[1080px] mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
              <div className="lg:col-span-2">
                <div className="mb-4"><Wordmark isDark={isDark} height={28} /></div>
                ...
                <div key={col.title}>
                  ...
                  <ul className="flex flex-col gap-2.5">
                    {col.links.map(([label, href]) => (
                      <li key={label}><Link to={href} className="font-inter text-[13px] transition-colors hover:text-accent" style={{ color: T.t3 }}>{label}</Link></li>
                    ))}
                  </ul>
                </div>
              ))}
