  ...
  return (
    <PublicLayout fullWidth>
      ...
      <section className="relative overflow-hidden pt-28 pb-20 px-6 qp-grid-bg">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="qp-reveal">
            <GradientBadge color="#7b39fc">Our story</GradientBadge>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="relative rounded-3xl overflow-hidden border border-[#7b39fc]/20 p-10 sm:p-16 qp-reveal"
          style={{ background: 'linear-gradient(135deg, rgba(123,57,252,.05) 0%, var(--surface) 50%, rgba(14,165,233,.05) 100%)' }}>
          <div className="absolute top-0 right-0 w-64 h-64 rounded-full opacity-10 pointer-events-none"
            style={{ background: '#7b39fc', filter: 'blur(60px)', transform: 'translate(30%, -30%)' }} />
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <div className="font-manrope font-extrabold text-2xl sm:text-3xl text-[var(--text-primary)] leading-relaxed mb-6">
              ...
              <span className="text-[#7b39fc]"> enterprise-grade tools </span>
              at ₹499/month."
            </div>
            <div className="flex items-center justify-center gap-3">
              <div className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-white"
                style={{ background: 'linear-gradient(135deg, #7b39fc, #0ea5e9)' }}>DR</div>
      ...
      <section className="py-20 px-6 qp-grid-bg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14 qp-reveal">
            <GradientBadge color="#7b39fc">What we stand for</GradientBadge>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-14 qp-reveal">
          <GradientBadge color="#7b39fc">The team</GradientBadge>
          <h2 className="font-manrope font-extrabold text-4xl sm:text-5xl text-[var(--text-primary)] tracking-tight">
          ...
          {TEAM.map((m, i) => (
            <div key={m.name}
              ...
              <div className="w-20 h-20 rounded-full flex items-center justify-center font-bold text-2xl text-white mx-auto mb-5"
                style={{ background: `linear-gradient(135deg, ${m.color}, #4f46e5)` }}>
                {m.avatar}
              </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-28">
        <div className="relative overflow-hidden rounded-3xl p-12 sm:p-16 text-center border border-[#7b39fc]/20"
          style={{ background: 'linear-gradient(135deg, rgba(123,57,252,.08) 0%, var(--surface) 50%, rgba(14,165,233,.06) 100%)' }}>
          <div className="qp-reveal">
            <GradientBadge color="#7b39fc">Join us</GradientBadge>
